        ...
        try:
            ...
            for line in f:##((line = in.readLine()) != null)
                ...
                if(line.startswith("G1")):
                    ...
                    self.deltadist=math.sqrt((self.deltax*self.deltax) + (self.deltay*self.deltay) +(self.deltaz*self.deltaz))
                    ...
                    if(self.deltadist==0):
                        ...
                        if self.fiveDaccel== True:
                            ...
                            if (self.frate==self.oldfrate):
                                ...
                                self.accel = ((self.frate*self.frate)-(self.oldfrate*self.oldfrate))/(2*self.deltadist)
...
##                                
##                                self.accel = ((self.frate*self.frate) - (self.min_units_per_second*self.min_units_per_second)) / (2*self.full_velocity_units)
##
...
##                                        acceldistance = (acceltime * self.min_units_per_second) + (0.5*self.accel*acceltime*acceltime);
...
##                                    else:
##
##                                        self.frate= math.sqrt((self.min_units_per_second*self.min_units_per_second) + (self.accel*self.deltadist));
